...
void gui_drawrect(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, gui_color_t color, uint8_t fill)
{
	...
	__gui_draw_rect(xn, yn, xk, yk, color, fill);
}
...
void gui_drawrect_rounded(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint8_t radius, gui_color_t color, uint8_t fill)
{
	...
	__gui_draw_rounded_rect(xn, yn, xk, yk, radius, color, fill);
}
...
void gui_drawrect_transparent(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint8_t alpha)
{
	...
	__gui_draw_semitransparent_rect(xn, yn, xk, yk, GUI_COLOR_DARKGRAY, alpha);
}
...
void gui_canvas_draw_rect(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, gui_color_t color, uint8_t fill)
{
	...
	__gui_draw_rect(xn, yn, xk - xn, yk - yn, color, fill);
}
...
void gui_canvas_draw_rect_rounded(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint8_t radius, gui_color_t color, uint8_t fill)
{
	...
	__gui_draw_rounded_rect(xn, yn, xk - xn, yk - yn, radius, color, fill);
}
...
void gui_canvas_draw_rect_transparent(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, gui_color_t color, uint8_t alpha)
{
	...
	__gui_draw_semitransparent_rect(xn, yn, xk, yk, color, alpha);
}
